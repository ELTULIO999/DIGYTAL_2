...
# 2 "<built-in>" 2
# 1 "juego_de_carreras.c" 2
# 12 "juego_de_carreras.c"
...
# 42 "juego_de_carreras.c"
void Setup (void);
void delay (char n);
void led_E (void);
void suma_C (unsigned char n);
void led_C (char n );

unsigned char L, M, l, m;
